...
func NewContourQueryRange(n int32, graph [][]int32) *ContourQueryRange {
	...
	comp := []int32{}
	dep := []int32{}
	f := func(par []int32, vs []int32, color []int32) {
		n := int32(len(par))
		dist := make([]int32, n)
...
func centroidDecomposition(n int32, g [][]int32, f func([]int32, []int32, []int32)) {
	if n == 1 {
		return
	}
	V := make([]int32, n)
...
func centroidDecomposition2DFS(par []int32, vs []int32, real []int32, f func([]int32, []int32, []int32)) {
	N := int32(len(par))
	if N <= 1 {
