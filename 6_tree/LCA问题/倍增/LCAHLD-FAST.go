...
func (tree *LCAHLD) Build(root int) {
	if root != -1 {
...
func (tree *LCAHLD) Id(root int) (int, int) {
	return tree.LID[root], tree.RID[root]
}

// 返回返回边 u-v 对应的 欧拉序起点编号, 1 <= eid <= n-1., 0-indexed.
func (tree *LCAHLD) Eid(u, v int) int {
...
func (tree *LCAHLD) LCA(u, v int) int {
	for {
		if tree.LID[u] > tree.LID[v] {
			u, v = v, u
		}
...
func (tree *LCAHLD) Dist(u, v int, weighted bool) int {
	if weighted {
...
func (tree *LCAHLD) KthAncestor(root, k int) int {
...
func (tree *LCAHLD) Jump(from, to, step int) int {
	if step == 1 {
		if from == to {
			return -1
		}
...
func (tree *LCAHLD) CollectChild(root int) []int {
	res := []int{}
...
func (tree *LCAHLD) GetPathDecomposition(u, v int, vertex bool) [][2]int {
	up, down := [][2]int{}, [][2]int{}
	for {
		if tree.top[u] == tree.top[v] {
			break
...
func (tree *LCAHLD) EnumeratePathDecomposition(u, v int, vertex bool, f func(start, end int)) {
	for {
		if tree.top[u] == tree.top[v] {
			break
		}
...
func (tree *LCAHLD) GetPath(u, v int) []int {
	res := []int{}
...
func (tree *LCAHLD) build(cur, pre, dep, dist int) int {
