...
// 树上差分离线版.区间加,单点查询.
func NewRangeAddPointGetTreeOffline(n int, isVertex bool) *RangeAddPointGetTreeOffline {}

func (r *RangeAddPointGetTreeOffline) AddPoint(root int) {}

func (r *RangeAddPointGetTreeOffline) AddPath(u, v int) {}

// O(n) 构建.
func (r *RangeAddPointGetTreeOffline) GetDistToRoot() []E {}
