...
//  Get(key Key) (value Value, found bool)
//  Discard(key Key) bool
//  Empty() bool
//  Size() int
//  Keys() []Key
//  Values() []Value
//  Clear()
//  Min() (key Key, value Value, ok bool)
//  Max() (key Key, value Value, ok bool)
//  Floor(key Key) (foundkey Key, foundvalue Value, ok bool)
//  Ceiling(key Key) (foundkey Key, foundvalue Value, ok bool)
//  Lower(key Key) (foundkey Key, foundvalue Value, ok bool)
//  Higher(key Key) (foundkey Key, foundvalue Value, ok bool)

//  LowerBound(key Key) (iterator Iterator, ok bool)
//  UpperBound(key Key) (iterator Iterator, ok bool)
...
func main() {
	mp := NewTreeMap(func(a, b Key) int {
		return a[0] - b[0]
	})
	mp.Set(Key{3, 4}, Value{5})
	mp.Set(Key{1, 2}, Value{3})
...
func NewTreeMap(comparator func(a, b Key) int) *TreeMap {
	return &TreeMap{tree: _NewRedBlackTree(comparator)}
}

func (m *TreeMap) Set(key Key, value Value) {
	m.tree.Put(key, value)
}

func (m *TreeMap) Get(key Key) (value Value, found bool) {
	return m.tree.Get(key)
}

func (m *TreeMap) Discard(key Key) bool {
...
func (m *TreeMap) Keys() []Key {
	return m.tree.Keys()
}

func (m *TreeMap) Values() []Value {
...
func (m *TreeMap) Min() (key Key, value Value, ok bool) {
...
func (m *TreeMap) Max() (key Key, value Value, ok bool) {
...
func (m *TreeMap) Floor(key Key) (foundkey Key, foundvalue Value, ok bool) {
...
func (m *TreeMap) Ceiling(key Key) (foundkey Key, foundvalue Value, ok bool) {
...
func (m *TreeMap) Lower(key Key) (foundkey Key, foundvalue Value, ok bool) {
...
func (m *TreeMap) Higher(key Key) (foundkey Key, foundvalue Value, ok bool) {
...
func (m *TreeMap) ForEach(f func(value Value, key Key)) {
	iterator := m.Iterator()
	for iterator.Next() {
		f(iterator.Value(), iterator.Key())
	}
}
