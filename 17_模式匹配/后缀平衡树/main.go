...
// https://github.com/EndlessCheng/codeforces-go/blob/49f6570d86c17f5064a5b079360f4128acc520c4/copypasta/scapegoat_tree.go#L4
//
// 后缀平衡树(动态后缀数组)
...
// 后缀平衡树支持在字符串开头删除一个字符、复杂度不依赖于字符集的大小.
