 ...
 * @deprecated
 */
class ACAutoMatonLegacy<S extends string | ArrayLike<number> = string> {
  /**
   * `模式串/模式串unicode编码`列表.
   */
...
export { ACAutoMatonLegacy }

if (require.main === module) {
  // 1032. 字符流
  // https://leetcode.cn/problems/stream-of-characters/
  class StreamChecker {
    private readonly _acm: ACAutoMatonLegacy
    private _state = 0
    constructor(words: string[]) {
      this._acm = new ACAutoMatonLegacy()
