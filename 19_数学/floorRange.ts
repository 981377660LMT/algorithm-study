 ...
 */
function enumerateFloorInterval(lower: number, upper: number, f: (left: number, right: number, div: number) => void): void {
 ...
 */
function enumerateFloor2D(n: number, m: number, f: (x1: number, x2: number, y1: number, y2: number, div1: number, div2: number) => void): void {
