# https://judge.yosupo.jp/submission/84129
# 多项式/幂级数
...
def linear_recurrence(arr, coeff, k):  # a(n) * c(0) + a(n - 1) * c(1) + ... + a(n - d) * c(d) = 0
    if arr.__class__ == FormalPowerSeries:
        arr = arr.arr
    d = len(arr)
...
# print(~A)  # invert 多项式求逆
# print(A.exp())  # exp 泰勒展开
# print(A.log())
# print(A.sqrt())
# print(A**M)  # pow
...
# print(*F.multipoint_evaluation(points))
# 多点评价 (Multipoint Evaluation) 求出多项式在给定点的值

# print(polynomial_interpolation(x, y))
# 多项式插值 (Polynomial Interpolation) 求出给定点的多项式

# print(F.taylor_shift(offset))
