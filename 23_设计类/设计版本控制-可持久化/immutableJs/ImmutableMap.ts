...
class ArrayMapNode<K, V> {
  constructor(public ownerID: OwnerID, public entries: Array<[K, V]>) {}
...
class BitmapIndexedNode<K, V> {
  constructor(public ownerID: OwnerID, public bitmap: number, public nodes: Array<MapNode<K, V>>) {}
...
class HashArrayMapNode<K, V> {
  constructor(public ownerID: OwnerID, public count: number, public nodes: Array<MapNode<K, V>>) {}
...
class HashCollisionNode<K, V> {
  constructor(public ownerID: OwnerID, public keyHash: number, public entries: Array<[K, V]>) {}
...
class MapIterator<K, V> implements Iterator<any>, Iterable<any> {
  ...
  constructor(map: ImmutableMap<K, V>, public _type: IterationType, public _reverse: boolean) {
