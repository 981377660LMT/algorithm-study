...
func main() {
	{
		arr1, arr2 := []uint16{1, 2, 3, 4, 5}, []uint16{3, 4, 5, 6, 7}
		buffer := make([]uint16, len(arr1)+len(arr2))
		pos := union2by2(arr1, arr2, buffer)
		fmt.Println(buffer[:pos]) // [1 2 3 4 5 6 7]
	}

	{
		arr1, arr2 := []uint16{1, 2, 3, 4, 5}, []uint16{3, 4, 5, 6, 7}
		buffer := make([]uint16, len(arr1)+len(arr2))
		pos := difference(arr1, arr2, buffer)
		fmt.Println(buffer[:pos]) // [1 2]
	}

	{
		arr1, arr2 := []uint16{1, 2, 3, 4, 5}, []uint16{3, 4, 5, 6, 7}
		buffer := make([]uint16, len(arr1)+len(arr2))
		pos := exclusiveUnion2by2(arr1, arr2, buffer)
		fmt.Println(buffer[:pos]) // [1 2 6 7]
	}

	{
		arr1, arr2 := []uint16{1, 2, 3, 4, 5}, []uint16{3, 4, 5, 6, 7}
		buffer := make([]uint16, len(arr1)+len(arr2))
		pos := intersection2by2(arr1, arr2, buffer)
		fmt.Println(buffer[:pos]) // [3 4 5]
	}

	{
		arr1, arr2 := []uint16{1, 2, 3}, []uint16{3, 4, 5, 6, 7}
		fmt.Println(intersects2by2(arr1, arr2)) // true
	}

	{
		arr1, arr2 := []uint16{1, 2, 3}, []uint16{4, 5, 6, 7}
		fmt.Println(intersects2by2(arr1, arr2)) // false
	}

	{
		arr1, arr2 := []uint16{1, 2, 3}, []uint16{4, 5, 6, 7}
		fmt.Println(union2by2Cardinality(arr1, arr2)) // 7
	}

	{
		arr1, arr2 := []uint16{3, 4}, []uint16{4, 5, 6, 7}
		fmt.Println(intersection2by2Cardinality(arr1, arr2)) // 0
	}
...
// symmetricDifference 返回set1和set2的对称差集到buffer中, 返回结果长度.
