...
public class BinarySearch {
  ...
  public static double firstTrue(DoublePredicate predicate, double l, double r, double absError,
  ...
  public static double lastTrue(DoublePredicate predicate, double l, double r, double absError,
      double relativeError) {
