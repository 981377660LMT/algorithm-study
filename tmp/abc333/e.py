...
# ​
#   のポーションを
# 1 つ発見する。高橋くんは、発見したポーションを拾うか捨てるかのどちらかを選択する。
# t
# i
# ​
#  =2 のとき、タイプ
...
# ​
#   のポーションを持っている場合、それを
# 1 つ消費することでモンスターを撃退することができる。モンスターを撃退しなかった場合、高橋くんは敗北する。
...
if __name__ == "__main__":
    ...
    # 每次遇到怪物，找左边最近的对应的药水
    mp = defaultdict(ATCSortedList)  # 药水位置
    need = set()
