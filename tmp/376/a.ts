...
// TODO1: 抽象distSum函数
// TODO2: SortedList修复、添加SortedListFastWithSum的distSum函数(内部所有数到某个数的距离和)
...
// [1,2,6,4]
// 3
// console.log(maxFrequencyScore([1, 2, 4, 6], 3))
// [1,4,4,2,4]
// 0
console.log(maxFrequencyScore([1, 4, 4, 2, 4], 0))
// [10,11,3]
// 1
console.log(maxFrequencyScore([10, 11, 3], 1))
