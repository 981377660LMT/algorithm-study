import { EditorState, Transaction, Plugin, Command } from '../state'
import { NodeType, Attrs, Node } from '../model'
...
action.
*/
declare function inputRules({ rules }: { rules: readonly InputRule[] }): Plugin<{
