import { EditorState, Transaction, Selection, Plugin } from './state'
import { Mark, Node, ParseRule, Slice, ResolvedPos, DOMParser, DOMSerializer } from './model'
...
*/
declare type NodeViewConstructor = (
  node: Node,
  view: EditorView,
...
mark views.
*/
declare type MarkViewConstructor = (
  mark: Mark,
  view: EditorView,
  inline: boolean
) => {
