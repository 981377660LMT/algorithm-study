...
// 树状数组拆分前缀/后缀区间.
type DivideIntervalPrefixSuffix struct {
	n      int32
	height int32
}

func NewDivideIntervalPrefixSuffix(n int32) *DivideIntervalPrefixSuffix {
	return &DivideIntervalPrefixSuffix{}
}

func (d *DivideIntervalPrefixSuffix) EnumeratePrefix(end int32, f func(nodeId int32)) {}

// 不断增大的操作只会影响所有位置不小于 的信息（或和这样的信息有关），
// 不断减小的操作只会影响所有位置不大于 的信息（或和这样的信息有关）。
// int n, c[N];
...
func (d *DivideIntervalPrefixSuffix) EnumerateSuffix(start int32, f func(nodeId int32)) {}

func (d *DivideIntervalPrefixSuffix) Lca(u, v int32) int32 {
	return 0
}

func (d *DivideIntervalPrefixSuffix) Depth(u int32) int32 {}

func (d *DivideIntervalPrefixSuffix) IsLeaf(nodeId int32) bool {}

func (d *DivideIntervalPrefixSuffix) Parent(nodeId int32) int32 {}
